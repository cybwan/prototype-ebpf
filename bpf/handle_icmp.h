...
swap_mac_and_send(void *data, void *data_end) {
  struct ethhdr *eth;
...
__attribute__((__always_inline__)) static inline int
send_icmp_reply(void *data, void *data_end) {
  struct iphdr *iph;
...
__attribute__((__always_inline__)) static inline int
send_icmp6_reply(void *data, void *data_end) {
  struct ipv6hdr *ip6h;
...
__attribute__((__always_inline__)) static inline int
send_icmp4_too_big(struct xdp_md *xdp) {
...
__attribute__((__always_inline__)) static inline int
send_icmp6_too_big(struct xdp_md *xdp) {
...
__attribute__((__always_inline__)) static inline int
parse_icmpv6(void *data, void *data_end, __u64 off,
...
__attribute__((__always_inline__)) static inline int
parse_icmp(void *data, void *data_end, __u64 off,
           struct packet_description *pckt) {
  struct icmphdr *icmp_hdr;
  struct iphdr *iph;
  icmp_hdr = data + off;
...
ignorable_quic_icmp_code(void *data, void *data_end, bool is_ipv6) {
  ...
  if (is_ipv6) {
    ...
    return ((icmp_hdr->icmp6_code == ICMPV6_ADDR_UNREACH) ||
